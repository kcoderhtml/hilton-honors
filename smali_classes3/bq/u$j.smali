...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lbq/u;->a0(Ljava/lang/String;Lcom/mobileforming/module/common/model/hilton/graphql/NonPamRateDetailsQuery$Builder;)Lio/reactivex/Single;
.end annotation
...
.field final synthetic i:Lcom/mobileforming/module/common/model/hilton/graphql/NonPamRateDetailsQuery$Builder;


# direct methods
.method constructor <init>(Lbq/u;Ljava/lang/String;Lcom/mobileforming/module/common/model/hilton/graphql/NonPamRateDetailsQuery$Builder;)V
    .locals 0

    .line 1
    iput-object p1, p0, Lbq/u$j;->g:Lbq/u;

    .line 2
    .line 3
    iput-object p2, p0, Lbq/u$j;->h:Ljava/lang/String;

    .line 4
    .line 5
    iput-object p3, p0, Lbq/u$j;->i:Lcom/mobileforming/module/common/model/hilton/graphql/NonPamRateDetailsQuery$Builder;
...
.method public static synthetic a(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)Lcom/hilton/android/module/book/api/hilton/model/RateDetailsResponse;
    ...
    .line 1
    invoke-static {p0, p1}, Lbq/u$j;->b(Lkotlin/jvm/functions/Function1;Ljava/lang/Object;)Lcom/hilton/android/module/book/api/hilton/model/RateDetailsResponse;
...
.method public final invoke(Ljava/lang/String;)Lio/reactivex/SingleSource;
    ...
    .line 4
    iget-object v1, p0, Lbq/u$j;->h:Ljava/lang/String;

    new-instance v2, Lcom/mobileforming/module/common/retrofit/model/GraphRequestModel;

    iget-object v3, p0, Lbq/u$j;->i:Lcom/mobileforming/module/common/model/hilton/graphql/NonPamRateDetailsQuery$Builder;

    invoke-virtual {v3, p1}, Lcom/mobileforming/module/common/model/hilton/graphql/NonPamRateDetailsQuery$Builder;->guestId(Ljava/lang/Object;)Lcom/mobileforming/module/common/model/hilton/graphql/NonPamRateDetailsQuery$Builder;

    move-result-object p1

    invoke-virtual {p1}, Lcom/mobileforming/module/common/model/hilton/graphql/NonPamRateDetailsQuery$Builder;->build()Lcom/mobileforming/module/common/model/hilton/graphql/NonPamRateDetailsQuery;
    ...
    invoke-interface {v0, v1, v2}, Leq/a;->a(Ljava/lang/String;Lcom/mobileforming/module/common/retrofit/model/GraphRequestModel;)Lio/reactivex/Single;

    move-result-object p1

    .line 5
    sget-object v0, Lbq/u$j$a;->g:Lbq/u$j$a;

    new-instance v1, Lbq/d0;

    invoke-direct {v1, v0}, Lbq/d0;-><init>(Lkotlin/jvm/functions/Function1;)V
...
.method public bridge synthetic invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Lbq/u$j;->invoke(Ljava/lang/String;)Lio/reactivex/SingleSource;
